...
### [ssurface/cot-dialect-math-olmo3-7b-think-grpo-cf-s1337-l1](https://huggingface.co/ssurface/cot-dialect-math-olmo3-7b-think-grpo-cf-s1337-l1)
**Author:** ssurface  
**Task:** general  
...
### [zjhhhh/fixed-n-rb-cost-aware-marginrl-qwen3-1.7b-base-math12k-step_100](https://huggingface.co/zjhhhh/fixed-n-rb-cost-aware-marginrl-qwen3-1.7b-base-math12k-step_100)
**Author:** zjhhhh  
**Task:** general  
**License:** `unspecified` ❓ license not confirmed  
**Size:** ~7B (from model name)  
...
**Why relevant:** Matched for **Optimisation & Reasoning** via task match: text-generation, tag match: code, code-generation, reasoning. Capabilities: supports tool/function calling; strong code generation capability; available in quantized/offline-friendly formats.
...
**Why relevant:** Matched for **Optimisation & Reasoning** via tag match: code (name). Capabilities: multimodal / vision capability; available in quantized/offline-friendly formats.
